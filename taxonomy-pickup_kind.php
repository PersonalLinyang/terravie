...
$pick_up_kind = get_queried_object();
$base_url = get_site_url() . '/pickupanimal/kind/' . $pick_up_kind->slug . '/';
...
$args_base = array(
  ...
  'tax_query'        => array(
    array(
      'taxonomy'     => 'pickup_kind',
      'field'        => 'slug',
      'terms'        => $pick_up_kind->slug,
    )
  ),
);
...
<p class="pickup-top"><?php echo $pick_up_kind->name; ?>の<br class="sp-only" />PICK UP ANIMAL</p>
